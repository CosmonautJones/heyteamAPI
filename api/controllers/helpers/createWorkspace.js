...
module.exports = createWorkspace = async (body, req, res) => {
  ...
  return res.redirect(
    `https://slack.com/oauth/authorize?client_id=270618182930.333388702161&scope=bot,incoming-webhook,search:read&redirect_uri=https://heyteamapi.herokuapp.com/auth/bot`
  );
};
